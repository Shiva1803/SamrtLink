...
export function PublicProfile() {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      // TODO: Replace with actual user ID from profile route parameter
      const userId = '123456'; // This should come from the URL or profile data

      const response = await fetch(`${API_CONFIG.BASE_URL}${API_CONFIG.ENDPOINTS.CHAT(userId)}`, {
        method: 'POST',
        headers: {
      ...
      setChatHistory(prev => [
        ...
        {
          role: 'ai',
          message: error instanceof Error ? error.message : 'Sorry, I encountered an error. Please try again later.'
        }
      ]);
  ...
  return (
    ...
    >
      {/* Header Section */}
      <div className="bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/70 border-b border-neutral-200 sticky top-0 z-40">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          >
            <Card className="p-6 bg-white border-neutral-200 sticky top-6">
              ...
              {/* Chat Messages */}
              <div className="space-y-4 mb-6 h-[60vh] overflow-y-auto pr-1">
